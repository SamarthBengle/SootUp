...
public class PathBasedAnalysisInputLocationIT extends AnalysisInputLocation {
  ...
  public void testSingleClassWPackageName() {
    sootup.core.inputlocation.AnalysisInputLocation pathBasedNamespace =
  ...
  public void testRuntimeJar() {
    sootup.core.inputlocation.AnalysisInputLocation pathBasedNamespace = new DefaultRuntimeAnalysisInputLocation();
